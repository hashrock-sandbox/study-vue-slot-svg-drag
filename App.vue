<template>
  <div>
    ...
    <svg-canvas v-slot="slotProps">
      <g>
        <line stroke="black" :x1="points[0].x" :y1="points[0].y" :x2="points[1].x" :y2="points[1].y">
      </g>
      <svg-draggable v-for="(point, idx) in points" :key="idx" v-slot="drag" :point="point" @change="updatePoint(point, $event)">
